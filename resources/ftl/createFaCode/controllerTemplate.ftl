package com.zlht.controller.${packageName}.${objectNameLower};
...
import com.zlht.service.${packageName}.${objectNameLower}.${objectName}Manager;
import com.zlht.service.${packageName}.${objectNameLower}mx.${objectName}MxManager;
