			...
			<div id="zhongxin" style="padding-top: 13px;">
				<table id="table_report" class="table table-striped table-bordered table-hover">
					...
					<tr>
						...
						<td><input type="number" name="ITEM" id="ITEM" value="${pd.ITEM}" maxlength="32" placeholder="这里输入分期期次" title="分期期次" style="width:38%;"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="number" name="COMMISSION" id="COMMISSION" value="${pd.COMMISSION}" maxlength="32" placeholder="这里输入手续费" title="手续费" style="width:38%;"/>%</td>
					</tr>
					<tr>
