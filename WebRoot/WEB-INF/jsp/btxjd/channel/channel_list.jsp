						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center">对公账号</th>
									<th class="center">开户行支行</th>
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.PUBLICACCOUNT}</td>
											<td class='center'>${var.ACCOUNTBANK}</td>
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													...
													<a class="btn btn-mini btn-purple" onclick="band('${var.CHANNEL_ID}','${var.CHANNELNAME}');">
														<i class="ace-icon fa bigger-120" title="绑定分期">绑定分期</i>
													</a>
													<a class="btn btn-mini btn-info" onclick="del('${var.CHANNEL_ID}');">
												...
												<div class="hidden-md hidden-lg">
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															<c:if test="${QX.edit == 1 }">
															<li>
																<a style="cursor:pointer;"  onclick="band('${var.CHANNEL_ID}','${var.CHANNELNAME}');" class="tooltip-success" data-rel="tooltip" title="修改">
																	<span class="green">
															...
															<c:if test="${QX.del == 1 }">
															<li>
																<a style="cursor:pointer;" onclick="del('${var.CHANNEL_ID}');" class="tooltip-error" data-rel="tooltip" title="删除">
																	<span class="red">
