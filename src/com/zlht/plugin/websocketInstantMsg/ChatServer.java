package com.zlht.plugin.websocketInstantMsg;
...
public class ChatServer extends WebSocketServer{
	...
	public void onMessage(WebSocket conn, String message){
		...
		if(null != message && message.startsWith("WEBSOCKETADMIN")){
			this.userjoin(message.replaceFirst("WEBSOCKETADMIN", ""),conn);
		}if(null != message && message.startsWith("LeaveWEBSOCKETADMIN")){
			this.userLeave(conn);
