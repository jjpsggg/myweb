package com.zlht.controller.system.tools;
...
public class ToolController extends BaseController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/severDemo")
	@ResponseBody
	public Object severDemo() throws UnsupportedEncodingException{
		Map<String,String> map = new HashMap<String,String>();
		PageData pd =  this.getPageData();
		String FKEY = MD5.md5(pd.getString("S_TYPE_S")+new SimpleDateFormat("yyyyMMdd").format(new Date())+",fh,");
		String errInfo = "success",str = "",rTime="";
		try{
			long startTime = System.currentTimeMillis(); 					//请求起始时间_毫秒
			URL url = new URL(pd.getString("serverUrl")+"&FKEY=" + FKEY);
			HttpURLConnection connection = (HttpURLConnection) url.openConnection();
			connection.setRequestMethod(pd.getString("requestMethod"));		//请求类型  POST or GET
