package com.zlht.controller.btxjd.organization;
...
public class OrganizationController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("btxjd/organization/organization_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		mv.setViewName("btxjd/organization/organization_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var1", varOList.get(i).getString("ORGANIZATIONNAME"));	    //1
