package com.zlht.controller.btxjd.credit;
...
public class CreditController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("btxjd/credit/credit_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("btxjd/credit/credit_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var2", varOList.get(i).get("INSTALMENTORDER").toString());	//2
			vpd.put("var3", varOList.get(i).get("INSTALMENTFEE").toString());	//3
			vpd.put("var4", varOList.get(i).get("PAYEDFEE").toString());	//4
			vpd.put("var5", varOList.get(i).get("INTEREST").toString());	//5
			vpd.put("var6", varOList.get(i).getString("STARTTIME"));	    //6
			vpd.put("var7", varOList.get(i).getString("ENDTIME"));	    //7
			vpd.put("var8", varOList.get(i).getString("PAYEDTIME"));	    //8
			vpd.put("var9", varOList.get(i).getString("PAYEDTYPE"));	    //9
			varList.add(vpd);
		}
