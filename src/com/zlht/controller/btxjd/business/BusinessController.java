package com.zlht.controller.btxjd.business;
...
import com.zlht.service.btxjd.business.BusinessManager;
...
public class BusinessController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("btxjd/business/business_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("btxjd/business/business_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var1", varOList.get(i).getString("BUSINESSNAME"));	    //1
			vpd.put("var2", varOList.get(i).getString("BUSINESSACCOUNT"));	    //2
			vpd.put("var3", varOList.get(i).getString("BUSINESSBANK"));	    //3
			varList.add(vpd);
		}
